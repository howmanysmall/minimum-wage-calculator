...
const useHookAtTopLevel = defineRule({
	create(context): Visitor {
		...
		return {
			...
			"ConditionalExpression:exit": function (): void {
			...
			"DoWhileStatement:exit": function (): void {
			...
			"ForInStatement:exit": function (): void {
				updateContext({ inLoop: false });
			},
			...
			"ForOfStatement:exit": function (): void {
				updateContext({ inLoop: false });
			},
			...
			"ForStatement:exit": function (): void {
				updateContext({ inLoop: false });
			},
			...
			"IfStatement:exit": function (): void {
				updateContext({ inConditional: false });
			},
			...
			"LogicalExpression:exit": function (): void {
				updateContext({ inConditional: false });
			},

			"ReturnStatement:exit": function (): void {
			...
			"SwitchStatement:exit": function (): void {
				updateContext({ inConditional: false });
			},
			...
			"TryStatement:exit": function (): void {
			...
			"WhileStatement:exit": function (): void {
				updateContext({ inLoop: false });
			},
		};
	},
